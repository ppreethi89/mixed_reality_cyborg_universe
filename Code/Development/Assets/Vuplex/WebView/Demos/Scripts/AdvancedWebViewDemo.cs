...
namespace Vuplex.WebView.Demos {
    ...
    class AdvancedWebViewDemo : MonoBehaviour {
        ...
        void Start() {
            ...
            EventHandlerScript.webViewPrefab = _mainWebViewPrefab;
            _mainWebViewPrefab.transform.parent = transform;
            _mainWebViewPrefab.transform.localPosition = new Vector3(0, -0.035f, 0f);
            _mainWebViewPrefab.transform.localScale = new Vector3(0.1591145f, 0.2591145f, 0.1591145f);
            ...
            _controlsWebViewPrefab.transform.localScale = new Vector3(1, 1, 1);
        ...
        void _setUpKeyboards() {
            ...
            keyboard.transform.localScale = new Vector3(1.205034f, 1.205034f, 1.205034f);
