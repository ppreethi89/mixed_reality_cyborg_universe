...
public class LineGraphController_O2 : MonoBehaviour
{
    [SerializeField]
    ...
    private void Awake()
    {
        viewport = this.transform.Find("Viewport_O2") as RectTransform;
        content = viewport.Find("Content_O2") as RectTransform;
        xAxis = this.transform.Find("X Axis_O2").gameObject;
        yAxis = this.transform.Find("Y Axis_O2").gameObject;
        xUnitLabel = this.transform.Find("X Unit Label_O2").gameObject;
        yUnitLabel = this.transform.Find("Y Unit Label_O2").gameObject;
