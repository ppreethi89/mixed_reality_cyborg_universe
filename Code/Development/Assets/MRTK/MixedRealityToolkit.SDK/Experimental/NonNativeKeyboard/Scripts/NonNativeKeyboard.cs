...
namespace Microsoft.MixedReality.Toolkit.Experimental.UI
{
    ...
    public class NonNativeKeyboard : InputSystemGlobalHandlerListener, IMixedRealityDictationHandler
    {
        ...
        public void OnDictationResult(DictationEventData eventData)
        {
            ...
            ResetClosingTime();
            //Comment out because of listen mode
            /*if (text != null)
            {
        ...
        public void FunctionKey(KeyboardKeyFunc functionKey)
        {
            ...
            switch (functionKey.ButtonFunction)
            {
                ...
                case KeyboardKeyFunc.Function.DelWord:
                    {
                        DelWord();
                        break;
                    }
                case KeyboardKeyFunc.Function.Clear:
                    {
                        Clear();
                        break;
                    }
        ...
        public void DelWord()
        {
            ...
            string result = ConvertStringArrayToStringJoin(parts);
            Debug.Log(result);
            InputField.text = result;
            InputField.caretPosition = result.Length;
